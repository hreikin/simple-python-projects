...
def printTable():
    # Finds the amount of columns from how many lists are within the list 
    # "tableData".
    ...
    i = 0
    # Each list is the same length (specified by the task) so len() is the same 
    # regardless
    while i < len(tableData[0]):
        column_tracker = 0
        # Print each item accessed by using i for the correct index. This also 
        # works for column_lengths
