...
locations = ["Germany", "England", "Spain", "France", "Holland"]
...
print("Original Locations.")
print(locations)
print("Sorted & Reversed Locations.")
print(sorted(locations, reverse = True))
print("Original Locations.")
print(locations)
print("Reversed Locations New List.")
locations.reverse()
print(locations)
print("New Original List.")
locations.reverse()
print(locations)
print("Sorted Locations With Sort().")
locations.sort()
print(locations)
print("Reversed Sorted Locations With Sort().")
